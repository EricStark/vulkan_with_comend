...
private:
    ...
    void createTextureSampler() {
        ...
        samplerInfo.addressModeU = VK_SAMPLER_ADDRESS_MODE_REPEAT;    // U 坐标寻址模式
        samplerInfo.addressModeV = VK_SAMPLER_ADDRESS_MODE_REPEAT;    // V 坐标寻址模式
        samplerInfo.addressModeW = VK_SAMPLER_ADDRESS_MODE_REPEAT;   // W 坐标寻址模式
        ...
        samplerInfo.mipmapMode = VK_SAMPLER_MIPMAP_MODE_LINEAR;      // Mipmap 过滤模式
